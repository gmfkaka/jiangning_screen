<template>
  <div class="position-relative">
    ...
    <related-reports v-if="type === 'm2o-plus'" :id="id"></related-reports>
    <hottest-content v-else-if="type === 'workcall'" :id="id" :token="token"></hottest-content>
    <wechat-list v-else-if="type === 'old'"></wechat-list>
  </div>
</template>
<script>
import relatedReports from '../relatedReports/relatedReports'
import hottestContent from '../hottestContent/hottestContent'
import wechatList from '../wechatList/wechatList'
