    ...
    <div class="call-wrap sys-flex" v-if="call_Show">
        <div id="call-main" class="rong-container sys-flex sys-flex-center flex-justify-center">
            <div class="call-user" v-if="!online">
                ...
                <img class="call-reporter-avatar" v-if="!info_item.avatar" src="../../assets/img/reporter/default_avatar.png" />
                <img class="call-reporter-line" src="../../assets/img/reporter/pic_soundwave.png">
...
export default {
    ...
    mounted(){
        document.documentElement.style.fontSize = document.documentElement.clientWidth / 5760*100 + 'px'
        setTimeout(()=>{
            initRong();
    ...
    methods: {
        ...
        commandMap(res){
            switch (res.messageType) {
                case 'InviteMessage': 
                    // this.$api.getMemberInfo(res.senderUserId , '686e6f65e3907d0e15e1a991b01aaa4').then((response)=>{
...
<style lang="scss">
    .call-wrap{
        width: 100%;
        height: 100%;
        border: 0.02rem solid rgba(96, 186, 236, 0.2);
        ...
        #call-main{
            ...
            .video-info{
                ...
                .hug-btn{
                    ...
                    width: 3rem;
                    height: 3rem;
                    background:url(../../assets/img/reporter/icon_videoff.png) no-repeat center center;
        ...
        .call-info-wrap{
            width: 3.08rem;
            height: 3.78rem;
            // background: url(../../assets/ji_an/workcallInfo/pic_message_border.png) no-repeat center center;
            ...
            .reporter-name{
                ...
                text-align: left;
                color: #00ffea;
                // background: url(../../assets/ji_an/workcallInfo/pic_arrow_big.png) no-repeat center left;
            ...
            .info-list{
                ...
                &.introduce{
                    height: 0.28rem;
                    // background-image:url(../../assets/ji_an/workcallInfo/icon_date.png);
        ...
        .close-btn{
            ...
            width: 0.97rem;
            height: 0.28rem;
            // background:url(../../assets/ji_an/btn_return.png) no-repeat center center;
